...
export default function Pricing() {
  return (
    <Container className="pb-[60px] px-3">
      <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-3">
      <div className="">
      <div className="rounded-2xl">
          <div className="flex flex-col justify-between w-full h-full bg-gray-100 px-7 rounded-t-2xl py-7 dark:bg-trueGray-800">
          ...
          <div className="flex flex-col justify-between w-full h-full bg-gray-100 px-7 rounded-b-2xl pt-3 pb-9 bg-[#F9F9F9] dark:bg-[#2b2b2b]">
