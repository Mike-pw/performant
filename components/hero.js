    ...
    <>
      <Container className="flex flex-wrap py-15">
          <div className="mx-auto max-w-2xl mb-8">
            <h1 className="text-center text-5xl font-bold leading-snug tracking-tight text-gray-800 lg:text-7xl lg:leading-tight xl:text-8xl xl:leading-tight dark:text-white">
              Performant
            </h1>
            <h2 className="text-center py-0 text-2xl leading-normal text-red-500 lg:text-2xl xl:text-3xl">
            ...
            <div className=" py-3 mx-auto w-3/4 flex flex-col justify-around space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                href="#services"
                className="flex justify-center space-x-2 text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white">
